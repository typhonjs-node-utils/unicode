...
describe('unicode trie', () =>
{
   ...
   it('toBuffer written in little-endian', () =>
   {
      ...
      // TODO: For single pass deflate const bufferExpected = Buffer.from([0, 72, 0, 0, 0, 0, 0, 0, 128, 36, 0, 0, 237, 206, 49, 10, 192, 32, 12, 64, 81, 233, 212, 177, 99, 199, 142, 189, 69, 123, 23, 47, 234, 209, 12, 136, 179, 163, 130, 239, 195, 35, 100, 74, 174, 35, 165, 59, 60, 225, 13, 125, 223, 105, 2, 0, 235, 250, 22, 248, 1, 0, 0, 0, 0, 0, 24, 43, 103, 243, 79, 34, 169, 149, 39, 220, 172]);
      const bufferExpected = Buffer.from([0, 72, 0, 0, 0, 0, 0, 0, 128, 36, 0, 0, 123, 123, 206, 144, 235, 128, 2, 143, 67, 224, 203, 43, 27, 147, 143, 247, 237, 117, 173, 22, 215, 127, 117, 145, 167, 99, 243, 226, 166, 247, 135, 149, 83, 188, 214, 41, 47, 181, 182, 121, 200, 91, 123, 63, 147, 137, 225, 245, 47, 177, 31, 140, 12, 32, 32, 161, 157, 254, 217, 95, 105, 229, 84, 245, 59, 107, 0]);
